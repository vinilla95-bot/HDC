...
export default function QuoteListPage({ onGoLive }: { onGoLive?: () => void }) {
 ...
 const previewHtml = useMemo(() => {
  ...
  const itemRows = items.map((raw, idx) => {
    ...
    return `<tr>
      <td style="border:1px solid #333;padding:6px 8px;text-align:center;background:#fff;">${idx + 1}</td>
      <td style="border:1px solid #333;padding:6px 8px;text-align:left;background:#fff;">${escapeHtml(it.name)}</td>
      <td style="border:1px solid #333;padding:6px 8px;text-align:center;background:#fff;">${specText}</td>
      <td style="border:1px solid #333;padding:6px 8px;text-align:center;background:#fff;">${qty}</td>
      <td style="border:1px solid #333;padding:6px 8px;text-align:right;background:#fff;">${money(unitSupply)}</td>
      <td style="border:1px solid #333;padding:6px 8px;text-align:right;background:#fff;">${money(supply)}</td>
      <td style="border:1px solid #333;padding:6px 8px;text-align:right;background:#fff;">${money(vat)}</td>
      <td style="border:1px solid #333;padding:6px 8px;background:#fff;">&nbsp;</td>
    </tr>`;
  });

  const blanks = Math.max(0, MIN_ROWS - items.length);
  for (let i = 0; i < blanks; i++) {
    itemRows.push(`<tr style="height:28px;">
      <td style="border:1px solid #333;padding:6px 8px;background:#fff;">&nbsp;</td>
      <td style="border:1px solid #333;padding:6px 8px;background:#fff;">&nbsp;</td>
      <td style="border:1px solid #333;padding:6px 8px;background:#fff;">&nbsp;</td>
      <td style="border:1px solid #333;padding:6px 8px;background:#fff;">&nbsp;</td>
      ...
      <div style="width:700px;min-height:1123px;background:#fff;border:1px solid #cfd3d8;padding:16px;box-sizing:border-box;">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;padding:6px 2px 10px;border-bottom:2px solid #2e5b86;margin-bottom:10px;">
          <div style="display:flex;align-items:center;gap:10px;">
            <img src="https://i.postimg.cc/VvsGvxFP/logo1.jpg" alt="logo" style="width:120px;height:auto;" />
          </div>
        ...
        <table style="width:100%;border-collapse:collapse;table-layout:fixed;border:1px solid #333;margin-top:8px;">
          ...
          <tbody>
            <tr>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">담당자</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;" colspan="3">${escapeHtml(bizcardName)}</td>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">견적일자</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">${ymd}</td>
            </tr>
            <tr>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">고객명</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;" colspan="3">
                <div style="display:flex;justify-content:space-between;">
                  <span>${escapeHtml(customerName)}</span>
                  <span style="font-weight:900;">귀하</span>
                </div>
              </td>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">공급자</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">현대컨테이너</td>
            </tr>
            <tr>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">이메일</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">${escapeHtml(customerEmail)}</td>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;text-align:center;background:#fff;">전화</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">${escapeHtml(customerPhone)}</td>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">등록번호</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">130-41-38154</td>
            </tr>
            <tr>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">현장</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">${escapeHtml(siteName)}</td>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;text-align:center;background:#fff;">견적일</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">${today.toLocaleDateString("ko-KR")}</td>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">상호</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">현대컨테이너</td>
            </tr>
            <tr>
              <td style="border:1px solid #333;padding:6px 8px;font-weight:700;text-align:center;background:#fff;" colspan="4">견적요청에 감사드리며 아래와 같이 견적합니다.</td>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">주소</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">경기도 화성시<br />향남읍 구문천안길16</td>
            </tr>
            <tr>
              <td style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;" colspan="4">합계금액 : ₩${money(totalAmount)} (부가세 포함)</td>
              <th style="border:1px solid #333;padding:6px 8px;font-weight:900;background:#fff;">전화</th>
              <td style="border:1px solid #333;padding:6px 8px;background:#fff;">1688-1447</td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="width:100%;border-collapse:collapse;table-layout:fixed;border:1px solid #333;margin-top:8px;">
          ...
          <thead>
            <tr>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">순번</th>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">품목</th>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">규격</th>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">수량</th>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">단가</th>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">공급가</th>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">세액</th>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">비고</th>
            </tr>
          </thead>
          <tbody>
            ${itemRows.join('')}
        ...
        <table style="width:100%;border-collapse:collapse;table-layout:fixed;border:1px solid #333;margin-top:8px;">
          ...
          <tbody>
            <tr>
              <td style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:left;" colspan="2">합계: ${money(totalAmount)}원 (총공급가액 ${money(supplyAmount)} / 총세액 ${money(vatAmount)})</td>
              <td style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:right;">${money(supplyAmount)}</td>
              <td style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:right;">${money(vatAmount)}</td>
              <td style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:right;">${money(totalAmount)}</td>
            </tr>
            <tr>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">결제조건</th>
              <td style="border:1px solid #333;padding:6px 8px;font-size:12px;line-height:1.55;" colspan="4">계약금 50%입금 후 도면제작 및 확인/착수, 선 완불 후 출고</td>
            </tr>
            <tr>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">주의사항</th>
              <td style="border:1px solid #333;padding:6px 8px;font-size:12px;line-height:1.55;" colspan="4">
            ...
            <tr>
              <th style="border:1px solid #333;padding:6px 8px;background:#e6e6e6;font-weight:900;text-align:center;">중요사항</th>
              <td style="border:1px solid #333;padding:6px 8px;font-size:12px;line-height:1.55;" colspan="4">
                *중요사항*<br />
